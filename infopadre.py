...
from infopadre3 import Info_padre3
from clientes import Cliente


class Info_padre(QMainWindow):
    def __init__(self, anterior):
        super(Info_padre, self).__init__(anterior)
    ...
    def metodo_accionFormaTabular(self):
        self.hide()
        self.infopadre3 = Info_padre3(self)
        self.infopadre3.show()
