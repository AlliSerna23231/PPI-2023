...
from obspsico import Observaciones_psicologo
...
class Interfaz2(QMainWindow):
    ...
    def __init__(self):
        ...
        # poner titulo
        self.setWindowTitle("Data Comunity -- Psicólog@")
        ...
        menu = self.menuBar()
        menu_lista = menu.addMenu("&Lista de Alumnos")
        ...
        menu_lista_abrir = QAction(QIcon(), "&Lista", self)
        menu_lista_abrir.setShortcut("Ctrl+e")  # atajo de tecladp
        menu_lista_abrir.setStatusTip("Lista generada")  # mensaje en la barra de estado
        menu_lista_abrir.triggered.connect(self.menu_lista_estudiante)  # lanzador
        menu_lista.addAction(menu_lista_abrir)
