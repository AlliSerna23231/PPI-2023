...
class  psicologo(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Formulario de Registro-- Psicólogo")
        ...
        self.letrero1.setText("Información del Psicologo")
        ...
        self.letrero2.setText("Por favor ingrese la información del psicologo"
        ...
        self.botonRegistrar.setStyleSheet("background-color: #A22F88;"
                                          "color: #FFFFFF;"
                                          "padding: 10px;"
                                          "margin-top: 40px;")
        ...
        self.botonLimpiar.setStyleSheet("background-color: #A22F88;"
                                          "color: #FFFFFF;"
                                          "padding: 10px;"
                                          "margin-top: 40px;")
        ...
        self.botonBuscar.setStyleSheet("background-color: #A22F88;"
                                          "color: #FFFFFF;"
                                          "padding: 10px;"
                                          "margin-top: 40px;")
        ...
        self.botonRecuperar.setStyleSheet("background-color: #A22F88;"
                                            "color: #FFFFFF;"
                                            "padding: 10px;"
                                            "margin-top: 40px;")
    ...
    def accion_botonBuscar(self):
        ...
        if (
            ...
            while self.file:
                ...
                if linea == '':
                    break
                # creamos un objeto tipo psicologo llamado u
                u = psicologo(
                    lista[0],
                    lista[1],
                    lista[2],
