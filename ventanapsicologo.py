...
class Ventana_psicologo(QMainWindow):
    def __init__(self, anterior=None):
        super(Ventana_psicologo, self).__init__()

        self.ventanaAnterior = anterior

        self.setWindowTitle("Formulario de Registro-- psicologo")
        ...
        self.letrero1.setText("Información del Psicólogo")
        ...
        self.letrero2.setText("Por favor ingrese la información del Psicólogo"
        ...
        # Les escribimos el e¿texto
        self.letrero4.setText("Por favor ingrese la información del Psicólogo"
                              "\nen el formulario de abajo. Los campos marcados"
                              "\ncon asterisco son obligatorios.")
        ...
        # Agregamos estos en el formulario:
        self.ladoDerecho.addRow("Licencia*",self.pin)
        ...
        self.ventanaDialogo.setWindowTitle("Formulario de Registro del Psicólogo")
    ...
    def accion_botonGuardar(self):
        ...
        if (
            ...
            cargo_valido = ["Psicólogo"]
            if self.cargo.currentText() not in cargo_valido:
                self.datosCorrectos = False
                self.mensaje.setText("Seleccione una cargo válido")
                self.ventanaDialogo.exec_()

            # Validar longitud de la licensia que solo se puedan colocar 6 digitos
            self.pin.setMaxLength(-6)
            if len(self.pin.text()) > 6:
                self.datosCorrectos = False
                self.mensaje.setText("La licensia no tiene los dígitos correspondientes")
                self.ventanaDialogo.exec_()
        ...
        if self.datosCorrectos:
            ...
            self.file = open('datos/psicologo.txt', 'ab')
            ...
            self.file = open('datos/psicologo.txt', 'rb')
            while self.file:
